...
const Tarjetas = ({name, price, users, gigas, support, textButton}) => {
    ...
    return (
        <Card sx={{width: 250, height:"100%",textAlign: 'center', borderRadius:3, display: 'flex', flexDirection:'column', justifyContent:'flex-end' }}>
            ...
            <CardContent >
                ...
                <ul>
                    <Typography fontWeight='500' variant="subtitle1" component="li">
